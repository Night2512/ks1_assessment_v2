// netlify/functions/get-submission-details.js
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const detailedResults = result.rows[0].detailed_results;

    return {
      statusCode: 200,
      body: JSON.stringify(detailedResults), // Send the JSONB directly
    };
  } catch (error) {
